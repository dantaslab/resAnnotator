...
class Annotate:
    """Class to predict resistome(s) from protein or nucleotide data based on CARD and Resfams"""
    ...
    def run_hmmscan(self,db_params):
        ...
        f_name = os.path.splitext(f_name)[0] 
        db_name = os.path.splitext(db_params['dbname'])[0]
        hmm_out = os.path.join(self.temp_dir,"{}_{}_tab.txt".format(f_name, str(db_name)))
